...
hangman.getGameStatus = function(word, guesses) {
  ...
  {
    if (hangman.isGuessWrong(guesses, word[i]) === false)
    {
      correct++
    }
  }
  ...
  {
    if (hangman.isGuessWrong(word, guesses[i]) === false)
    {
    counter++
    }
  ...
  if (negativecounter === -hangman.maxWrongGuesses)
  {
    return 'lose'
  }
  return 'in_progress'
...
hangman.makeGuess = function(letter) {
  ...
  console.log(3)
  console.log(hangman.game.guesses)
  hangman.game.guesses.push(letter)
  console.log(hangman.game.guesses.length)
  console.log(hangman.game.guesses)
  /*
  console.log(hangman.game.guesses)
  console.log(letter)
  var lol = hangman.game.guesses.length
  var yo = letter
  hangman.game.guesses[lol] = yo;
  console.log(hangman.game.guesses[0]) */
